...
By default, the container is exposed on a public IP. Consider:
- Using Azure Virtual Networks for private deployment
- Implementing Azure Front Door or Application Gateway for additional security
